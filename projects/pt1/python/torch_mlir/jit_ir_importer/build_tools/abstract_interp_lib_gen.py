...
GML_MOE_OP_TESTS = [
    Invocation(
        ...
        [TensorOfShape(768, 2048, dtype=torch.float32)], # w1 list of [inter_size, hidden_size] per expert
        [TensorOfShape(2048, 768, dtype=torch.float32)], # w2 list of [hidden_size, inter_size] per expert
