...
"    %1 = torch.aten.__isnot__ %arg1, %none : !torch.optional<list<int>>, !torch.none -> !torch.bool\n"
"    %2 = torch.prim.If %1 -> (!torch.list<int>) {\n"
"      %3 = torch.prim.unchecked_cast %arg1 : !torch.optional<list<int>> -> !torch.list<int>\n"
"      %4 = torch.aten.__getitem__.t %arg0, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %5 = torch.aten.__getitem__.t %arg0, %int1 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %6 = torch.aten.__getitem__.t %3, %int0 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %7 = torch.aten.__getitem__.t %3, %int1 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %8 = torch.prim.ListConstruct %4, %5, %6, %7 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"      torch.prim.If.yield %8 : !torch.list<int>\n"
"    } else {\n"
"      %3 = torch.aten.__isnot__ %arg2, %none : !torch.optional<list<float>>, !torch.none -> !torch.bool\n"
"      %4 = torch.prim.If %3 -> (!torch.list<float>) {\n"
"        %18 = torch.prim.unchecked_cast %arg2 : !torch.optional<list<float>> -> !torch.list<float>\n"
"        torch.prim.If.yield %18 : !torch.list<float>\n"
"      } else {\n"
"        torch.prim.RaiseException %str, %none : !torch.str, !torch.none\n"
...
"      %7 = torch.aten.__getitem__.t %arg0, %int2 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %8 = torch.aten.Float.Scalar %7 : !torch.int -> !torch.float\n"
"      %9 = torch.aten.__getitem__.t %4, %int0 : !torch.list<float>, !torch.int -> !torch.float\n"
"      %10 = torch.aten.mul.float %8, %9 : !torch.float, !torch.float -> !torch.float\n"
"      %11 = torch.aten.Int.float %10 : !torch.float -> !torch.int\n"
"      %12 = torch.aten.__getitem__.t %arg0, %int3 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %13 = torch.aten.Float.Scalar %12 : !torch.int -> !torch.float\n"
"      %14 = torch.aten.__getitem__.t %4, %int1 : !torch.list<float>, !torch.int -> !torch.float\n"
"      %15 = torch.aten.mul.float %13, %14 : !torch.float, !torch.float -> !torch.float\n"
"      %16 = torch.aten.Int.float %15 : !torch.float -> !torch.int\n"
"      %17 = torch.prim.ListConstruct %5, %6, %11, %16 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"      torch.prim.If.yield %17 : !torch.list<int>\n"
"    }\n"
"    return %2 : !torch.list<int>\n"
"  }\n"
