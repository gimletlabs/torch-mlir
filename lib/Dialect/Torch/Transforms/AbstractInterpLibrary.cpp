...
"    return %0#1 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.gml.fused_moe\"(%arg0: !torch.list<int>, %arg1: !torch.list<list<int>>, %arg2: !torch.list<list<int>>, %arg3: !torch.list<list<int>>, %arg4: !torch.list<int>, %arg5: !torch.list<int>) -> !torch.list<int> {\n"
"    return %arg0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.gml.fused_moe\"(%arg0: !torch.tuple<int, int>, %arg1: !torch.list<tuple<int, int>>, %arg2: !torch.list<tuple<int, int>>, %arg3: !torch.list<tuple<int, int>>, %arg4: !torch.tuple<int, int>, %arg5: !torch.tuple<int, int>) -> !torch.int {\n"
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    return %0#1 : !torch.int\n"
"  }\n"
"}\n"
